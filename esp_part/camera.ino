...
// const char* websockets_server_host = "10.19.208.172"; //CHANGE HERE
const char* websockets_server_host = "192.168.84.49"; //CHANGE HERE
const uint16_t websockets_server_port = 3000; // OPTIONAL CHANGE
