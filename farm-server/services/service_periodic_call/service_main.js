...
// });
    ...
    // service.register("periodicallyCallService", function (msg) {
    //     console.log("setAlarmService 호출");
    //     periodicallyCallService(msg);  // 알람을 설정하는 함수 호출
    
    //     setInterval(() => {
    //         periodicallyCallService({ respond: (response) => console.log(response) }); // msg.respond 대신 로그 출력
    //     }, intervalTime);
