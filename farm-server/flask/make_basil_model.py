...
with open('stacked_basil_model.pkl', 'wb') as f:
    pickle.dump(model, f)
print("basil 모델이 regression_model.pkl로 저장되었습니다.")

# scaler를 pickle 파일로 저장
with open('basil_scaler.pkl', 'wb') as f:
    pickle.dump(scaler, f)
print("scaler가 basil_scaler.pkl로 저장되었습니다.")
