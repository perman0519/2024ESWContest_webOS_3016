...
const receivedSensorDataService = new Service("com.control.sensor.service");
    ...
    if (!serverStarted) {
        ...
        wss.on("connection", (socket) => {
            ...
            socket.on("message", (message) => {
                ...
                // receivedSensorDataService.call("luna://com.control.sensor.service/getSensorData", {}, (response) => {
